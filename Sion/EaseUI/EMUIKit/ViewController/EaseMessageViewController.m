...
//                            [[EaseMessageReadManager defaultManager] showBrowserWithImages:@[image]];
//                            ImagePreviewVC *vc = [[ImagePreviewVC alloc] init];
//
...
//                    model.image = [UIImage sd_animatedGIFNamed:emotion.emotionOriginal];
                    NSLog(@"--------imageURL???????%@",emotion.emotionOriginalURL);
                    NSData *data = [NSData dataWithContentsOfURL:[NSURL URLWithString:emotion.emotionOriginal]];
