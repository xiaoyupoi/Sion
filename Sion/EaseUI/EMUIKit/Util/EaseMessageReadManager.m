...
/*
- (ImagePreviewVC *)photoBrowser
{
    if (_photoBrowser == nil) {
        _photoBrowser = [[ImagePreviewVC alloc] init];
        NSLog(_photoBrowser);
...
- (void)showBrowserWithImages:(NSArray *)imageArray
{
    ...
    */
//    self.performSegue
//    ImagePreviewVC(images: images, index: index)
//    ImagePreviewVC *imagePreview = [[ImagePreviewVC alloc] init];
//    
//    
//    self.photoNavigationController = [[UINavigationController alloc] initWithRootViewController:imagePreview];
